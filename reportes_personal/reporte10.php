<?php
    ...
    # objetivo: crear reporte "Docente en Posgrado Frente a Grupo por Grado"
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and nomenclatura like '%LP%' and tipo = 'federal'";
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%LT%' or nomenclatura like 'LICENCIATURA') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%ET%') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%MS%') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%MG%') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%DS%') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%DG%') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like '%TT%' or nomenclatura like '( C ) CERTIFICADO' or nomenclatura like '%TP%' or nomenclatura like '') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
...
EOF;
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like 'LP') and tipo = 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like 'LT' or nomenclatura like '') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and nomenclatura like 'ET' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and nomenclatura like 'MS' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like 'MG') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta= "select * from $BDSeleccionada where docente_posgrado = 'si' and nomenclatura like 'DS' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and nomenclatura like 'DG' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where docente_posgrado = 'si' and (nomenclatura like 'TT' or nomenclatura like 'C' or nomenclatura like 'TP' or nomenclatura like 'P' or nomenclatura like '-') and (tipo like 'estatal') and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
