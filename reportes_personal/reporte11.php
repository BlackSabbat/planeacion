<?php
    ...
    # objetivo: crear reporte de Investigadores Frente a Grupo por Edad y Antiguedad
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $query = "select * from $BDSeleccionada where docente_posgrado = 'si' and  tipo = 'federal'";
...
EOF;
    ...
    # Consulta Empleados Plaza Docente
    $query = "select * from $BDSeleccionada where docente_posgrado = 'si'and tipo = 'estatal' and observaciones not like '%dualidad de plaza%'";
    $result = $db->query($query);
