<?php
    ...
    # objetivo: crear reporte de Personal Plaza de Docente por Edad y Antiguedad
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $query = "select * from $BDSeleccionada where (plaza like 'E%') and tipo = 'federal'";
...
EOF;
    ...
    # Consulta Empleados Plaza Docente
    $query = "select * from $BDSeleccionada where (plaza like 'E%') and tipo = 'Estatal' and observaciones not like '%dualidad de plaza%'";
    $result = $db->query($query);
