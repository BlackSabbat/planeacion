<?php
    ...
    # objetivo: crear reporte de Personal Plaza de Apoyo por Edad y Antigüedad 
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    # Consulta Empleados con plaza no Plaza Docente
    $query = "select * from $BDSeleccionada where (plaza not like 'E%') and tipo = 'Federal'";
    ...
    print <<<EOF
        <tr>
            <th id="TotalesChico">Tot. (Edad)</th>
            ...
            <th id="TotalesChico">Tot. (Antig.)</th>
...
EOF;
    ...
    #-----------------------------------
    # Inicia Tabla Plantilla Estatañ
    #-----------------------------------
...
EOF;
    ...
    # Consulta Empleados Plaza Docente no docente
    $query = "select * from $BDSeleccionada where (plaza not like 'E%') and tipo = 'estatal' and observaciones not like '%dualidad de plaza%'";
    $result = $db->query($query);
