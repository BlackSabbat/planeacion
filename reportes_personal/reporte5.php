<?php
    ...
    # objetivo: crear reporte "Docente Frente a Grupo por Grado"
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $consulta = "select * from $BDSeleccionada where nomenclatura like '%LP%' and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%LT%' or nomenclatura like 'LICENCIATURA') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%ET%') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%MS%') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%MG%')  and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%DS%') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%DG%') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like '%TT%' or nomenclatura like '( C ) CERTIFICADO' or nomenclatura like '%TP%' or nomenclatura like '') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
...
EOF;
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like 'LP') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like 'LT' or nomenclatura like '') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where nomenclatura like 'ET' and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where nomenclatura like 'MS' and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like 'MG') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta= "select * from $BDSeleccionada where nomenclatura like 'DS' and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where nomenclatura like 'DG' and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
    ...
    $consulta = "select * from $BDSeleccionada where (nomenclatura like 'TT' or nomenclatura like 'C' or nomenclatura like 'TP' or nomenclatura like 'P' or nomenclatura like '-') and (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and (tipo like 'estatal') and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    $myEmpleado -> imprimirReporte1($rubro,$contadorHombre_TiempoCompleto, $contadorMujer_TiempoCompleto, $contadorHombre_TresCuartos, $contadorMujer_TresCuartos, $contadorHombre_MedioTiempo, $contadorMujer_MedioTiempo, $contadorHombre_Asignatura, $contadorMujer_Asignatura,$swPrintHeadings);
