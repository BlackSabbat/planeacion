<?php
    ...
    # objetivo: crear reporte de Personal Docente Frente a Grupo por Edad y Antiguedad
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $query = "select * from $BDSeleccionada where (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'federal'";
...
EOF;
    ...
    # Consulta Empleados Plaza Docente
    $query = "select * from $BDSeleccionada where (puesto like '%docent%' or puesto like 'DOCNETE' or esp_docente = 'si') and tipo = 'estatal' and observaciones not like '%dualidad de plaza%'";
    $result = $db->query($query);
