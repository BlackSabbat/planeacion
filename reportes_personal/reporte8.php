<?php
    ...
    # objetivo: crear reporte "Investigadores por Grado"
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%LP%' and tipo like 'federal'";
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like '%LT%' or nomenclatura like 'LICENCIATURA') and tipo like 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%ET%' and tipo like 'federal'";
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%MS%' and tipo like 'federal'";
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%MG%' and tipo like 'federal'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%DS%' and tipo like 'federal'";
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like '%DG%' and tipo like 'federal'";
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like '%TT%' or nomenclatura like '( C ) CERTIFICADO' or nomenclatura like '%TP%' or nomenclatura like '') and (tipo like 'federal')";
...
EOF;
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like 'LP' or nomenclatura like 'LS') and tipo like 'estatal'  and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like 'LT') and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like 'ET' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like 'MS' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like 'MG' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and nomenclatura like 'DS' and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta= "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like 'DG' or nomenclatura like 'DT')  and tipo like 'estatal' and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
    ...
    $consulta = "SELECT * FROM $BDSeleccionada where investigador = 'si' and (nomenclatura like 'TT' or nomenclatura like 'C' or nomenclatura like 'CER%' or nomenclatura like 'TP' or nomenclatura like 'P' or nomenclatura like 'DIP%' or nomenclatura like '-' or nomenclatura like '' or nomenclatura like ' ') and (tipo like 'estatal') and observaciones not like '%dualidad de plaza%'";
    $myEmpleado -> reporte1($consulta, $db, $host, $user, $pwd);
