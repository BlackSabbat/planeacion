<?php
    ...
    # objetivo: crear reporte de Investigadores por Edad y Antiguedad
    #-----------------------------------------------------------------------------
...
EOF;
    ...
    $query = "select * from $BDSeleccionada where investigador = 'si' and (plaza like 'E%') and tipo = 'federal'";
    $result = $db->query($query);
    //echo "registros: $result->num_rows</br>";
    //echo "$query </br>";
    ...
    while( $row = $result->fetch_assoc()) {
        ...
        //echo "CURP:$row[curp] Edad: $edad Antig: $antiguedad</br>";
        ...
        # obtener totales por rango de edades y de antiguedad de los empleados
...
EOF;
    ...
    # Consulta Empleados Plaza Docente
    $query = "select * from $BDSeleccionada where investigador = 'si' and (plaza like 'E%') and tipo = 'Estatal' and observaciones not like '%dualidad de plaza%'";
    $result = $db->query($query);
